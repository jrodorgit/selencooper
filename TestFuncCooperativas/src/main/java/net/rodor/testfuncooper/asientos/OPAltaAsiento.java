...
public class OPAltaAsiento extends OPAsientosBase {
	...
	public static void alta(WebDriver driver,VOAsiento vo) throws InterruptedException{
		...
		Thread.sleep(3000);
		elementoWebDivProc.findElement(By.xpath("//a[@data-normalized-text='Constitucion']")).click();
		Thread.sleep(2000);
		...
		driver.findElement(By.xpath("//button[@class='glyphicon glyphicon-arrow-left')]")).click();
